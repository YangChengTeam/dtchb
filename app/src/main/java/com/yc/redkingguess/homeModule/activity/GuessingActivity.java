...
import com.yc.redkingguess.dialog.GuessDialog;
import com.yc.redkingguess.homeModule.contact.GuessingContact;
...
import com.yc.redkingguess.homeModule.present.GuessingPresenter;
import com.yc.redkingguess.homeModule.widget.BarChartView;
import com.yc.redkingguess.homeModule.widget.NumberPickerView;
    ...
    private void loadExpressVideo() {
        ...
        adPlatformSDK.loadExpressAd(this, "ad_expredd_guess", dpw, dph, new AdCallback() {
            ...
            public void onNoAd(AdError adError) {
                Log.d("ccc", "----------onNoAd: "+adError.getCode()+"---"+adError.getMessage());
            }
