package com.yc.rrdsprj.utils.video;
...
public class Reflector {
    ...
    public static class DPReflectedException extends Exception {
        ...
        public DPReflectedException(String message) {
            super(message);
        }

        public DPReflectedException(String message, Throwable cause) {
            super(message, cause);
        }

    }

    public static Reflector on(String name) throws DPReflectedException {
        return on(name, true, Reflector.class.getClassLoader());
    }

    public static Reflector on( String name, boolean initialize) throws DPReflectedException {
        return on(name, initialize, Reflector.class.getClassLoader());
    }

    public static Reflector on( String name, boolean initialize, ClassLoader loader) throws DPReflectedException {
        try {
    ...
    public static Reflector with(Object caller) throws DPReflectedException {
    ...
    public Reflector constructor( Class<?>... parameterTypes) throws DPReflectedException {
        try {
    ...
    public <R> R newInstance(Object... initargs) throws DPReflectedException {
    ...
    protected Object checked(Object caller) throws DPReflectedException {
        if (caller == null || mType.isInstance(caller)) {
            return caller;
        }
        throw new DPReflectedException("Caller [" + caller + "] is not a instance of type [" + mType + "]!");
    }

    protected void check( Object caller,  Member member,  String name) throws DPReflectedException {
        if (member == null) {
            throw new DPReflectedException(name + " was null!");
        }
    ...
    public Reflector bind(Object caller) throws DPReflectedException {
    ...
    public Reflector field( String name) throws DPReflectedException {
        try {
    ...
    @SuppressWarnings("unchecked")
    public <R> R get( Object caller) throws DPReflectedException {
    ...
    public Reflector set(Object value) throws DPReflectedException {
        return set(mCaller, value);
    }

    public Reflector set( Object caller,Object value) throws DPReflectedException {
        check(caller, mField, "Field");
        try {
    ...
    public Reflector method( String name,  Class<?>... parameterTypes) throws DPReflectedException {
        try {
    ...
    public <R> R call( Object... args) throws DPReflectedException {
        return callByCaller(mCaller, args);
    }

    @SuppressWarnings("unchecked")
    public <R> R callByCaller( Object caller,Object... args) throws DPReflectedException {
...
//                Log.w(LOG_TAG, "Oops!", e);
        ...
        public static QuietReflector on( Class<?> type) {
            return on(type, (type == null) ? new DPReflectedException("Type was null!") : null);
        }
