...
public class MineRedDialog {
    private Context context;
    private Dialog dialog;
    private LinearLayout layout;
    private Display display;
    public MineRedDialog(Context context) {
    ...
    public View builder(int layoutID) {
        ...
        // 定义Dialog布局和参数
        dialog = new Dialog(context, R.style.center_red_top);
        ...
        layout.setLayoutParams(new FrameLayout.LayoutParams((int) (display
                .getWidth() * 1), ViewGroup.LayoutParams.WRAP_CONTENT));
