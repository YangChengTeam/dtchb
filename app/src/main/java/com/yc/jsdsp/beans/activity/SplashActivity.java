...
import com.yc.jsdsp.beans.module.beans.AdInfoBeans;
import com.yc.jsdsp.beans.module.beans.AdTypeBeans;
import com.yc.jsdsp.beans.module.beans.SplashBeanszq;
import com.yc.jsdsp.constants.Constant;
import com.yc.jsdsp.dialog.UpdateDialog;
import com.yc.jsdsp.dialog.YonghuxieyiDialog;
import com.yc.jsdsp.updata.DownloadManager;
import com.yc.jsdsp.utils.CacheDataUtils;
import com.yc.jsdsp.utils.CommonUtils;
import com.yc.jsdsp.utils.MacUtils;
import com.yc.jsdsp.utils.PermissionHelper;
import com.yc.jsdsp.utils.ad.TTAdManagerHolder;
...
public class SplashActivity extends SimpleActivity {
    ...
    public void  s(){
        UMConfigure.init(this, "62a97f1e05844627b5b270c5", ((MyApplication) MyApplication.getInstance()).getAgentId(), UMConfigure.DEVICE_TYPE_PHONE, "");
    ...
    private void showAgreementDialog(){
        ...
        String str = "欢迎使用极速短视频！我们非常重视您的隐私和个人信息保护，在您使用极速短视频，请认真阅读《隐私协议》和《用户协议》,您同意并接受全部条款后方可使用极速短视频。";
        ...
        ssb.setSpan(new ClickableSpan() {
            ...
            public void onClick(View widget) {
                ...
                intent1.putExtra("url", "http://m.k1u.com/gdgw/jsdsp.html");
        ...
        ssb.setSpan(new ClickableSpan() {
            ...
            public void onClick(View widget) {
                ...
                intent.putExtra("url", "http://m.k1u.com/xinshen/jsdsp.html");
