...
import com.yc.jsdps.beans.module.beans.AdInfoBeans;
import com.yc.jsdps.beans.module.beans.AdTypeBeans;
import com.yc.jsdps.beans.module.beans.SplashBeanszq;
import com.yc.jsdps.constants.Constant;
import com.yc.jsdps.dialog.UpdateDialog;
import com.yc.jsdps.dialog.YonghuxieyiDialog;
import com.yc.jsdps.updata.DownloadManager;
import com.yc.jsdps.utils.CacheDataUtils;
import com.yc.jsdps.utils.CommonUtils;
import com.yc.jsdps.utils.MacUtils;
import com.yc.jsdps.utils.PermissionHelper;
import com.yc.jsdps.utils.ad.TTAdManagerHolder;
...
public class SplashActivity extends SimpleActivity {
    ...
    public void  s(){
        UMConfigure.init(this, "629f17bf88ccdf4b7e8a6ae9", ((MyApplication) MyApplication.getInstance()).getAgentId(), UMConfigure.DEVICE_TYPE_PHONE, "");
        ...
        // 微信设置
        PlatformConfig.setWXFileProvider("com.yc.rrdsprj.service.FileProvider");
        PlatformConfig.setWeixin("wx32d361d4352eb7e0","cbc90a11d2af71facbfa986a46dd1298");
        getAdCode();
    }
