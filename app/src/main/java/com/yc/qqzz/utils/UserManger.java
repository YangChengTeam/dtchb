...
public class UserManger {
    ...
    public static void reglog(String agent_id){
       ...
       new HomeApiModule().reglog(imei,agent_id).compose(RxUtil.rxSchedulerHelper()).subscribe(new Subscriber<HttpResult<UserInfozq>>() {
           @Override
           ...
           @Override
           public void onNext(HttpResult<UserInfozq> userInfoHttpResult) {
