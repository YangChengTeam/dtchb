...
import com.yc.redevenlopes.homeModule.adapter.RollingTextAdapter;
...
public class TextViewSwitcher extends ViewAnimator {
    ...
    private static final int DEFAULT_IN_ANIMATION = R.anim.roll_text_in;

    private static final int DEFAULT_OUT_ANIMATION = R.anim.roll_text_out;
