...
public class SoundPoolUtils {
    ...
    public void initSound(){
        if (TextUtils.isEmpty(CacheDataUtils.getInstance().getSol())){
            ...
            if (music<=0){
                music= sp.load(MyApplication.getInstance().getApplicationContext(), R.raw.click, 1);// 1
    ...
    public void initSoundTwo(){
        if (TextUtils.isEmpty(CacheDataUtils.getInstance().getSol())){
            ...
            if (musictwo<=0){
                musictwo= sptwo.load(MyApplication.getInstance().getApplicationContext(), R.raw.lot, 1);// 1
