 ...
 */
public class WalletDetailAdapter extends BaseQuickAdapter<DisposeRecordInfo, BaseViewHolder> {
    public WalletDetailAdapter(@Nullable List<DisposeRecordInfo> data) {
