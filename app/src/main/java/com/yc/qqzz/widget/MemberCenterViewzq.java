 ...
 */
public class MemberCenterViewzq extends FrameLayout {
    private TextView tvContent;

    private ToggleButton toggleButton;

    public MemberCenterViewzq(@NonNull Context context) {
        this(context, null);
    }

    public MemberCenterViewzq(@NonNull Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public MemberCenterViewzq(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
