package com.yc.jsdsp.application;
...
import com.yc.jsdsp.beans.module.beans.ChannelInfozq;
import com.yc.jsdsp.constants.Constant;
import com.yc.jsdsp.di.component.AppComponent;
import com.yc.jsdsp.di.component.DaggerAppComponent;
import com.yc.jsdsp.di.module.AppModule;
import com.yc.jsdsp.utils.CardUtils;
import com.yc.jsdsp.utils.CommonUtils;
import com.yc.jsdsp.utils.FileUtil;
import com.yc.jsdsp.utils.ad.InitAdCallback;
import com.yc.jsdsp.utils.ad.TTAdManagerHolder;
import com.yc.jsdsp.utils.adgromore.GMAdManagerHolder;
import com.yc.jsdsp.utils.video.DPHolder;
...
public class MyApplication extends App {
    ...
    private void init() {
        ...
        TTAdManagerHolder.init(this, "5307153", Constant.APPNAME, false, new InitAdCallback() {
            @Override
...
//        //读取V2签名的渠道
    ...
    private void initUM() {
        ...
        UMConfigure.preInit(this,"62a97f1e05844627b5b270c5",agentId);
    }
