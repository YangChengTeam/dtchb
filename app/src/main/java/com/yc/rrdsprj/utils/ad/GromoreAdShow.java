...
import com.yc.rrdsprj.utils.DeleteFileUtil;
import com.yc.rrdsprj.utils.LogUtils;
            ...
            public void onRewardVideoAdLoad(TTRewardVideoAd ad) {
                ...
                mttRewardVideoAd.setRewardAdInteractionListener(new TTRewardVideoAd.RewardAdInteractionListener() {
                    ...
                    public void onAdShow() {
                        ...
                        int interactionType = mttRewardVideoAd.getInteractionType();
                        Map<String, Object> mediaExtraInfo = mttRewardVideoAd.getMediaExtraInfo();
                        Log.d("ccc", "---------------onRewardVideoAdLoad: "+mediaExtraInfo+"---"+mediaExtraInfo.size()+"---"+mediaExtraInfo.toString()+"-----:"+interactionType);
