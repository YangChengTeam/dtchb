...
import com.yc.qqzz.homeModule.fragment.ShareFragmentzq;
import com.yc.qqzz.homeModule.module.bean.OtherBeanszq;
import com.yc.qqzz.homeModule.module.bean.UserInfozq;
import com.yc.qqzz.homeModule.present.PersonInfoPresenter;
...
public class PersonInfoActivity extends BaseActivity<PersonInfoPresenter> implements PersonInfoContract.View{
            ...
            case R.id.tv_share_friend:
                ...
                shareFragment.setShareOnclickListen(new ShareFragmentzq.ShareOnclickListen() {
                    ...
                    public void weixinShare() {
                        shareWechatFriend(PersonInfoActivity.this, "http://m.k1u.com/az/2349.html");
                    }

                    @Override
                    public void weixinCircleShare() {
                        shareQQ(PersonInfoActivity.this, "http://m.k1u.com/az/2349.html");
                    }
                });
                shareFragment.show(getSupportFragmentManager(), "");
                break;
            case R.id.tv_logout:
                ActivityOptions opts = ActivityOptions.makeCustomAnimation(PersonInfoActivity.this,
    ...
    public void shareQQ(Context mContext, String content) {
        if (isInstalled(PersonInfoActivity.this, "com.tencent.mobileqq")) {
    ...
    public void shareWechatFriend(Context context, String content) {
        MobclickAgent.onEvent(PersonInfoActivity.this, "membershare");//参数二为当前统计的事件ID
        if (isInstalled(PersonInfoActivity.this, "com.tencent.mm")) {
...
//            intent.putExtra("sms_body", content);
    ...
    private void startShare(SHARE_MEDIA share_media) {
        ...
        mUMImage = new UMImage(getApplicationContext(), R.drawable.ic_launcher);
...
//            return;
                case VALID:
                    ...
                    isTxLoadAdSuccess = "1";
                    mRewardVideoAD
                            .showAD(PersonInfoActivity.this);
                    // 展示广告
                    break;
            }
        }
    ...
    public void loadTx() {
        mRewardVideoAD = new ExpressRewardVideoAD(this, Constant.TXRVIDEO, new ExpressRewardVideoAdListener() {
            ...
            public void onShow() {
                ...
                if (!CommonUtils.isDestory(PersonInfoActivity.this)) {
                    videoCounts = 1;
                }
            }
