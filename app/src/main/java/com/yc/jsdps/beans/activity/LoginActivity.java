...
import com.yc.jsdps.beans.contact.LoginContract;
import com.yc.jsdps.beans.module.HomeApiModule;
import com.yc.jsdps.beans.module.beans.UserInfo;
import com.yc.jsdps.beans.present.LoginPresenter;
...
//        finish();
    ...
    public class MyAuthLoginListener implements UMAuthListener {
        ...
        public void onError(SHARE_MEDIA share_media, int i, Throwable throwable) {
            ...
            ToastUtil.showToast("授权失败"+"----"+throwable.getMessage()+"--code:"+throwable.getLocalizedMessage());
        }
