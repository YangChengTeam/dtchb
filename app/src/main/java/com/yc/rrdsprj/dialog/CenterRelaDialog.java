...
public class CenterRelaDialog {
    ...
    public CenterRelaDialog(Context context) {
    ...
    public void setShow(){
     ...
     public void setOutSizeEable(boolean isEable){
           if (dialog!=null){
               dialog.setCanceledOnTouchOutside(isEable);
           }
     }
