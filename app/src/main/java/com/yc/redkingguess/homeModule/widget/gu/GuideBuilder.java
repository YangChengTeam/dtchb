package com.yc.redkingguess.homeModule.widget.gu;
 ...
 * {@link com.binioter.guideview.Component},设置文字或者图片等
 * {@link com.binioter.guideview.Component#getView(android.view.LayoutInflater)}
 * . 所有的图片文字都是相对于targetRect来定义的。可以设定额外的x，
 * {@link com.binioter.guideview.Component#getXOffset()} ;y偏移量,
 * {@link com.binioter.guideview.Component#getYOffset()}。
 * </p>
...
public class GuideBuilder {
    ...
    private OnTarLintens onTarLintens;
    /**
     * 构造函数
     */
    public GuideBuilder() {
     ...
     * 设置手势滑动的监听回调
     */
    public GuideBuilder setOnTarListener(
            OnTarLintens onTarListener) {
        if (mBuilt) {
            throw new BuildException("Already created, rebuild a new one.");
        }
        onTarLintens = onTarListener;
    ...
    public Guide createGuide() {
        ...
        if (onTarLintens!=null){
            guide.setOnTarListener(onTarLintens);
        }
        mComponents = null;
        mConfiguration = null;
     ...
     * 手势滑动监听
     */
    public static interface OnTarLintens {
        void onTarLinten();
    }
