...
import com.yc.majiaredgrab.homeModule.module.bean.SignWiths;
...
public class PersonApiModule {
    ...
    public Flowable<HttpResult<WeixinCashBeans>> cashMoney(String groupId, String wx, String cashMoney,String code,String tx_id) {
        return apis.cashMoney(groupId,wx,cashMoney, CacheDataUtils.getInstance().getUserInfo().getImei(),code,tx_id,"0");
    }
    ...
    public Flowable<HttpResult<EmptyBeans>> bonusescash(String imei, String valueOf) {
        return apis.bonusescash(imei,valueOf,"0");
    }
