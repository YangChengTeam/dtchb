...
public class VipTaskInfHomeBeans {
    ...
    public List<VipTaskInfoHomes> getTask_info() {
        return task_info;
    }

    public void setTask_info(List<VipTaskInfoHomes> task_info) {
