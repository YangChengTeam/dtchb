package com.yc.redkingguess.homeModule.widget.meteorshower;
...
public class MeteorShowerSurface extends SurfaceView implements SurfaceHolder.Callback,View.OnTouchListener{
    ...
    private int mDuration = 10*1500;//红包雨时长
    ...
    public MeteorShowerSurface setDuration(int duration){
        ...
        mCountDownTimer = new CountDownTimer(duration,1000) {
            ...
            public void onTick(long l) {
                ...
                if (countOnCountListen!=null){
                    countOnCountListen.getTimes((int)(l/1000));
                }
                if (mGameListener != null){
        ...
        switch (motionEvent.getAction()){
            case MotionEvent.ACTION_DOWN:
                ...
                if (sprite != null){
                    ...
                    mScore++;
                    if (countOnCountListen!=null){
                        countOnCountListen.getCount(mScore);
                    }
...
//                    }
   ...
   public CountOnCountListen countOnCountListen;
   public void setCountOnCountListen(CountOnCountListen listen){
          this.countOnCountListen=listen;
   }

   public interface  CountOnCountListen{
