package com.yc.rrdsprj.application;
...
import com.yc.rrdsprj.beans.module.beans.ChannelInfozq;
import com.yc.rrdsprj.constants.Constant;
import com.yc.rrdsprj.di.component.AppComponent;
import com.yc.rrdsprj.di.component.DaggerAppComponent;
import com.yc.rrdsprj.di.module.AppModule;
import com.yc.rrdsprj.utils.CardUtils;
import com.yc.rrdsprj.utils.CommonUtils;
import com.yc.rrdsprj.utils.FileUtil;
import com.yc.rrdsprj.utils.ad.InitAdCallback;
import com.yc.rrdsprj.utils.ad.TTAdManagerHolder;
import com.yc.rrdsprj.utils.adgromore.GMAdManagerHolder;
import com.yc.rrdsprj.utils.video.DPHolder;
...
public class MyApplication extends App {
    ...
    private void init() {
        ...
        TTAdManagerHolder.init(this, "5304691", Constant.APPNAME, false, new InitAdCallback() {
            @Override
...
//        //读取V2签名的渠道
    ...
    private void initUM() {
        ...
        UMConfigure.preInit(this,"629f17bf88ccdf4b7e8a6ae9",agentId);
    }
