package com.yc.rrdsprj.utils.adgromore;
...
import com.yc.rrdsprj.utils.AppSettingUtils;
import com.yc.rrdsprj.utils.CacheDataUtils;
import com.yc.rrdsprj.utils.ClickListenNameThree;
...
public class GromoreAdShowTwo {
    ...
    private static GromoreAdShowTwo instance;
    ...
    public void setContexts(Context contexts,String type){
    ...
    public void showjiliAd(String positions,String type,OnAdShowCaback onAdShowCaback ){
        ...
        if ("3".equals(type)){
            if (TextUtils.isEmpty(Constant.GROMOREJILIFIRSTRED)){
                if (onAdShowCaback!=null){
    ...
    private void loadAd() {
        ...
        if ("2".equals(types)||"3".equals(types)){
            if (TextUtils.isEmpty(Constant.GROMOREJILIFIRSTRED)){
                ad_code= Constant.GROMOREJILI;
            }else {
                ad_code= Constant.GROMOREJILIFIRSTRED;
            }
        }else {
            ad_code= Constant.GROMOREJILI;
        }
    ...
    private GMRewardedAdListener mTTRewardedAdListener = new GMRewardedAdListener() {
        public void onRewardedAdShow() {
            ...
            Log.d("ccc", "---onRewardedAdShow: "+"---code:"+ad_code+"---"+preEcpm+"---"+multiBiddingEcpm+"---adNetworkPlatformId:"+adNetworkPlatformId+"----"+adLoadInfoList+"---"+adNetworkRitId);
            loadAdCount=0;
            isTxLoadAdSuccess="3";
            if (onAdShowCaback!=null){
            ...
            if (!TextUtils.isEmpty(ad_positions)){
                AppSettingUtils.showTxShow(ad_positions,ad_code);
            }else {
                AppSettingUtils.showTxShow("jili",ad_code);
            }
        }
        @Override
        ...
        public void onRewardClick() {
            ...
            isVideoClick = true;
            if (!TextUtils.isEmpty(ad_positions)){
                AppSettingUtils.showTxClick(ad_positions,ad_code);
            }else {
                AppSettingUtils.showTxClick("jili",ad_code);
            }
        }
