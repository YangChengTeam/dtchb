...
public class OtherBeanszq implements Parcelable {
    ...
    protected OtherBeanszq(Parcel in) {
        this.id = in.readInt();
    ...
    public static final Parcelable.Creator<OtherBeanszq> CREATOR = new Parcelable.Creator<OtherBeanszq>() {
        @Override
        public OtherBeanszq createFromParcel(Parcel source) {
            return new OtherBeanszq(source);
        }

        @Override
        public OtherBeanszq[] newArray(int size) {
            return new OtherBeanszq[size];
        }
    };
}
